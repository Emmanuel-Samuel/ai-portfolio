...
function bannerEntry(): HistoryEntry {
  return {
    ...
    command: null,
    lines: [
      "Welcome to emmanuel@portfolio's terminal.",
      "Type 'help' to see available commands.",
      "The full site lives at '/' — type 'home' or 'exit' to go there.",
    ],
    revealed: 0,
  };
}
...
export default function TerminalApp() {
  ...
  return (
    <div
      className="h-dvh w-full bg-black text-green-500 font-mono text-sm sm:text-base p-4 overflow-hidden flex flex-col"
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pr-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            autoComplete="off"
            spellCheck={false}
            className="flex-1 min-w-0 bg-transparent outline-none border-none text-green-500 caret-transparent"
          />
          <span className="w-2 h-4 bg-green-500 animate-pulse" aria-hidden />
        </div>
      </div>
    </div>
  );
